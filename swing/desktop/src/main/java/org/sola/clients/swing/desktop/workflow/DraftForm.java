 ...
 * @author Admin
 */
public class DraftForm extends ContentPanel {
     ...
     */
    public DraftForm(ApplicationBean appBean, ApplicationServiceBean appServiceBean, Boolean readOnly) {
    ...
    private void customizeForm() {
        ...
        if (applicationBean != null) {
            headerPanel.setTitleText(String.format(bundle.getString("DraftForm.headerPanel.titleText"),
                    applicationBean.getNr()));
        }
        // Set the labels on the application service panel
        appServicePanel.lblActionDate.setText(bundle.getString("DraftForm.appServicePanel.lblActionDate.text"));
    ...
    private void initComponents() {
        ...
        appServicePanel.setFieldALabel("Plan Number");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(appServicePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(appServicePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 424, Short.MAX_VALUE))
        );
